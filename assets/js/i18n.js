    ...
    loadTranslations() {
        ...
        this.translations = {
            en: {
                ...
                'pricing.compare.secretary-header': 'Company Secretary',
                ...
                // Company Secretary comparison features
                'pricing.secretary.section1': 'Acting as Company Officers',
                'pricing.secretary.company-secretary': 'Company Secretary',
                'pricing.secretary.designated-rep': 'Designated Representative',
                'pricing.secretary.section2': 'Company Secretarial Services',
                'pricing.secretary.maintain-registers': 'Maintain company registration package to meet legal and capital registration requirements',
                'pricing.secretary.legal-records': 'Maintain company legal records',
                'pricing.secretary.nar1-filing': 'File Annual Return NAR1 (government fees not included)',
                'pricing.secretary.agm-draft': 'Draft Annual General Meeting and major meeting documents (AGM)',
                'pricing.secretary.section3': 'Basic Compliance Items',
                'pricing.secretary.registered-address': 'Registered office address for official correspondence',
                'pricing.secretary.mail-handling': 'Forward official mail and packages for legal processing',
                'pricing.secretary.filing-support': 'Official document preparation and notarization not requiring annual filing (up to HK$500 per filing)',
                'pricing.secretary.statutes-update': 'Update official statutes',
                'pricing.secretary.scr-filing': 'HKID card and passport scan filing (up to HK$295 per filing)',
            ...
            'zh-Hant': {
                ...
                'pricing.compare.secretary-header': '公司秘書',
                ...
                // Company Secretary comparison features
                'pricing.secretary.section1': '出任公司做伴',
                'pricing.secretary.company-secretary': '公司秘書委任',
                'pricing.secretary.designated-rep': '出任指定代表',
                'pricing.secretary.section2': '公司秘書服務',
                'pricing.secretary.maintain-registers': '備存公司登記冊達至要求的法律及資本登記冊',
                'pricing.secretary.legal-records': '備存公司的法定紀錄',
                'pricing.secretary.nar1-filing': '交付周年申報表 NAR1（政府收費另計）',
                'pricing.secretary.agm-draft': '草擬股東周年大會及大會文件（AGM）',
                'pricing.secretary.section3': '基本合規項目',
                'pricing.secretary.registered-address': '提供公司註冊地址以作官方通信',
                'pricing.secretary.mail-handling': '轉發官方信件及包裹以供法律處理',
                'pricing.secretary.filing-support': '官方文件準備及公證，不須年度申報（每次申報HK$500以內）',
                'pricing.secretary.statutes-update': '更新官方章程',
                'pricing.secretary.scr-filing': '香港身分證及護照掃描存檔（每次存檔HK$295以內）',
            ...
            'zh-Hans': {
                ...
                'pricing.compare.secretary-header': '公司秘书',
                ...
                // Company Secretary comparison features
                'pricing.secretary.section1': '出任公司做伴',
                'pricing.secretary.company-secretary': '公司秘书委任',
                'pricing.secretary.designated-rep': '出任指定代表',
                'pricing.secretary.section2': '公司秘书服务',
                'pricing.secretary.maintain-registers': '备存公司登记册达至要求的法律及资本登记册',
                'pricing.secretary.legal-records': '备存公司的法定纪录',
                'pricing.secretary.nar1-filing': '交付周年申报表 NAR1（政府收费另计）',
                'pricing.secretary.agm-draft': '草拟股东周年大会及大会文件（AGM）',
                'pricing.secretary.section3': '基本合规项目',
                'pricing.secretary.registered-address': '提供公司注册地址以作官方通信',
                'pricing.secretary.mail-handling': '转发官方信件及包裹以供法律处理',
                'pricing.secretary.filing-support': '官方文件准备及公证，不须年度申报（每次申报HK$500以内）',
                'pricing.secretary.statutes-update': '更新官方章程',
                'pricing.secretary.scr-filing': '香港身分证及护照扫描存档（每次存档HK$295以内）',
